...
import { HandCoins, Printer, Droplet, Filter, CalendarDays, XIcon, Sigma, MoreHorizontal, Edit, Trash2, Wallet } from 'lucide-react';
...
export function ServiceCommissionClient() {
  ...
  const { filteredCommissions, totalPrinterCommissions, totalTonerCommissions, overallTotalCommissions, overallTotalServiceValue } = useMemo(() => {
    const defaultReturn = { filteredCommissions: [], totalPrinterCommissions: 0, totalTonerCommissions: 0, overallTotalCommissions: 0, overallTotalServiceValue: 0 };
    ...
    let printerComm = 0, tonerComm = 0, printerServ = 0, tonerServ = 0;
    ...
    return { 
      ...
      overallTotalCommissions: printerComm + tonerComm,
      overallTotalServiceValue: printerServ + tonerServ
    };
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          <PdfExportButton
            ...
            overallTotalCommissions={overallTotalCommissions}
            overallTotalServiceValue={overallTotalServiceValue}
          />
              ...
              {filteredCommissions.map((c) => (
                <TableRow key={c.id}>
                  ...
                  <TableCell className="text-center">
                    {c.serviceType === 'printer' ? <Printer className="h-4 w-4 text-muted-foreground inline-block" /> : <Droplet className="h-4 w-4 text-muted-foreground inline-block" />}
                  </TableCell>
                  <TableCell>
                    {c.serviceValue === 0 ? (
